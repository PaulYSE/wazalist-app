...
const FIELD_LABELS = {
  name_jp: 'Name (JP)',
  name_en: 'Name (EN)',
  name_en_literal: 'Literal',
  name_en_gtranslate: 'Google Translate',
  tag: 'Skill level',
  reference: 'Reference / lore',
  parent_jp0: 'Parent JP 0',
  parent_en0: 'Parent EN 0',
  parent_jp1: 'Parent JP 1',
  parent_en1: 'Parent EN 1',
  author_jp0: 'Author (JP) 0',
  author_en0: 'Author (EN) 0',
  author_jp1: 'Author (JP) 1',
  author_en1: 'Author (EN) 1',
  video0: 'Video 1',
  video1: 'Video 2',
  video2: 'Video 3',
  video3: 'Video 4',
...
function renderQueue() {
  ...
  if (!queue.length) {
    el.innerHTML = '<div class="empty-queue">Nothing here</div>';
    return;
  }
  el.innerHTML = queue
    .map((c) => {
...
async function selectItem(id) {
  ...
  const wazaLabel = isNew
    ? payload.name_jp || '(no JP name)'
